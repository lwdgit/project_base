...
reasy
    ...
    .hook('amd', {
        ...
        shim: {
            'react': {
                deps: ['libs/es-shim.min', '/libs/es-sham.min', 'libs/console-polyfill']
            }
        },
    ...
    .extend('iconfont', {
        ...
        destFont: 'static/css/fonts',
        destCss: 'static/css/fonts.css',
        destHtml: 'static/css/demo.html'
    })
    //.extend('md5')


    .match('/static/js/libs/rsa/*.js', {
        packTo: 'static/js/login.js'
    })
    .match('/static/js/*.js', {
